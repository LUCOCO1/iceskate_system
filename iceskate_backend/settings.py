"""
Django settings for iceskate_backend project.
...
SECRET_KEY = 'django-insecure-!6ndx@4epfm-%(brhgzbif$!br870b*%fx)(=w%d4c2_kxe$1('
...
ROOT_URLCONF = 'iceskate_backend.urls'
...
WSGI_APPLICATION = 'iceskate_backend.wsgi.application'
...
SECURE_SSL_REDIRECT = False    # 开发环境设置为False
